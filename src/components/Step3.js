    ...
    render() {
        ...
        return (
            <div className="video-container">
                ...
                <div className="send-btn-sec"> <CustomButton onClick={this.startRecording} variant={"contained"} color={"primary"} text={"send my video"} fullWidth={true} /></div>
                {/* <video className="user-video" width="320" height="240" controls src={videoURL} ref={(ref) => { this.userVideo = ref; }}></video> */}
            </div>
        );
    }
}
